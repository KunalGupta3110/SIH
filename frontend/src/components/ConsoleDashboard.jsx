  ...
  const handleTakeSnapshot = async () => {
    ...
    try {
      ...
      if (targetVideo && targetVideo.readyState >= 2) {
        ...
        ctx.fillText(`SENTINEL FORENSIC SNAPSHOT · ${activeCam.name} [${activeCam.tag || "SURVEILLANCE"}]`, 20, height - barHeight * 0.55);
      ...
      if (!imageBlob) {
        ...
        ctx.fillText(`SENTINEL FORENSIC FRAME SNAPSHOT · ${activeCam.name}`, 60, 120);
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-[#000000] p-4.5 pb-24 space-y-4 lg:pb-4.5">
          ...
          <footer className="pt-3 border-t border-white/12 flex flex-col sm:flex-row items-center justify-between text-[11px] text-white/55 gap-2">
            <div className="flex items-center gap-3">
              <span className="font-semibold text-white">Sentinel v1.0.0</span>
              <span>|</span>
          ...
          <div className="w-full max-w-2xl bg-[#000000] border border-white/12 rounded-2xl shadow-2xl overflow-hidden animate-fadeIn p-6 space-y-4">
            ...
            <div className="p-4 rounded-xl bg-[#000000] border border-white/12 space-y-3 text-xs font-mono text-white max-h-[60vh] overflow-y-auto">
              <div className="text-center space-y-0.5 border-b border-white/12 pb-2">
                <div className="text-amber-300 text-[10px] font-bold">Specimen template · auto-generated by Sentinel · not an issued certificate</div>
              ...
              <div className="space-y-1.5 leading-relaxed text-[11px]">
                ...
                <p>
                  <strong>2. Machine &amp; Device Architecture:</strong> Sentinel cloud pipeline (hosted reference environment, Ubuntu 22.04 LTS), with per-tenant isolation and access logging.
                </p>
                <p>
